...
while True:
    ...
    if action == 0:
            ...
            for i in range(0,len(liststudent)):
              student_mark=float(input("Input mark for student number "+str(i+1)+":"))
            ...
            for i in range(0, len(marks)):
             print(f"{liststudent[i].student_id}\t{liststudent[i].student_name}\t{liststudent[i].student_dob}\t{math.floor(marks[i])}") 
